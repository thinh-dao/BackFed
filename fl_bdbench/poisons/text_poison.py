...
from fl_bdbench.utils.text_utils import Corpus
...
class TextPoison(Poison):
    ...
    def repackage_hidden(h):
        ...
        if isinstance(h, torch.Tensor):
            ...
            # Use the class name directly to avoid circular reference
            from fl_bdbench.poisons.text_poison import TextHelper
