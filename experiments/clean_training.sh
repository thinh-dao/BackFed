...
# *Reddit
python main.py -cn reddit num_rounds=5000 no_attack=True cuda_visible_devices=\"2,5,7\" save_checkpoint=True "save_model_rounds=[200,400,600,800,1000,1200,1400,1600,1800,2000]"